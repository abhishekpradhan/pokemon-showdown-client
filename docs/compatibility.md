...
| Battle decisions | Server request drives available mechanics and legal choices | Singles/doubles, forced switch/preview/targets, affected generations and modifiers |
...
| Spectating | Supported; unrevealed information remains unknown | p1/p2/spectator projection, public/private HP, joining/rejoining mid-battle |
...
| Audio/notifications | Optional; browser permissions and autoplay rules apply | Keyboard/pointer unlock, settings, unavailable audio and background notification behavior |
