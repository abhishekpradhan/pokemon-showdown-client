...
| Profile | Public trainer catalog with numeric alias resolution; avatar confirmation through own-user details, language acknowledgements, retry and reconnect reapplication | Store protocol transitions, browser selection/confirmation and actual server response contracts |
