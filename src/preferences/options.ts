...
export const isServerLanguage = (value: unknown): value is ServerLanguage =>
  typeof value === 'string' && Object.hasOwn(SERVER_LANGUAGES, value);
...
export const isBackground = (value: unknown): value is Background =>
  typeof value === 'string' && Object.hasOwn(BACKGROUNDS, value);
...
export const isMusicTrack = (value: unknown): value is MusicTrack =>
  typeof value === 'string' && Object.hasOwn(MUSIC_TRACKS, value);
