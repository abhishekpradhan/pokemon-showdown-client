// Numeric trainer aliases from the MIT-licensed Pokémon Showdown client.
// Source: ac7d535b28574ea3b48d5a4d1fbf6ca399abf469, battle-dex-data.ts.
...
export const avatarName = (value: string | number) => AVATAR_NAMES[String(value)] || String(value);
export const avatarUrl = (value: string | number | undefined): string | undefined => {
