...
it('animates the identified four-seat owner without animating their partner', () => {
  ...
  const { container, rerender } = render(
    <BattleField battle={battle} lastEvent={{ kind: 'hit', side: 'near', sideId: 'p3', slot: 0, at: 1 }} />,
  );
  ...
  rerender(
    <BattleField battle={battle} lastEvent={{ kind: 'attack', side: 'far', sideId: 'p4', slot: 0, at: 2 }} />,
  );
