...
const reviewed = new Set([
  ...
  'Python-2.0', 'BlueOak-1.0.0', 'CC-BY-4.0', 'CC-BY-3.0', 'AGPL-3.0-or-later',
  '(MIT OR CC0-1.0)', '(MIT AND Zlib)', 'MIT-0', 'Unlicense', 'MPL-2.0', '(MPL-2.0 OR Apache-2.0)',
]);
const packages = Object.entries(JSON.parse(readFileSync('package-lock.json', 'utf8')).packages).filter(([path]) => path.startsWith('node_modules/'));
